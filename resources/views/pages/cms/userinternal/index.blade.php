...
<div id="content">
    <div class="panel box-shadow-none content-header">
        <div class="panel-body">
            <div class="col-md-12">
                ...
                <p class="animated fadeInDown">CMS <span class="fa-angle-right fa"></span> Userinternal</p>
            </div>
        </div>
    </div>
    <div class="col-md-12 top-20 padding-0">
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading"><h3>Data Userinternal</h3>  <a href="{{url('/userinternal/create')}}"><button type="button" style="margin-bottom: 10px;" class="btn btn-success">Add New Userinternal</button></a></div>
                <div class="panel-body">
