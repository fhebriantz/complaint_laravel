    ...
    <div class="panel box-shadow-none content-header">
        <div class="panel-body">
            <div class="col-md-12">
                ...
                <p class="animated fadeInDown">CMS <span class="fa-angle-right fa"></span> Userinternal <span class="fa-angle-right fa"></span> Create</p>
            </div>
        </div>
    </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="responsive-table">
                        ...
                        @endif
                    	<form method="POST" action="{{url('/userinternal/create')}}">
						{{ csrf_field() }}
	                        <table class="table">  
                                ...
                                <tr>
                                    ...
                                    <td><input type="text"  class="form-control" name="branch_work_desc" required="" placeholder="Branch Work Desc" value="{{ old('branch_work_desc') }}" style="width: 100%"></td>
                                </tr>   
                                <tr>
                                    <td>Branch Work Base on SPU <em style="color:red">*</em></td>
                                    <td><input type="text"  class="form-control" name="branch_work_base_on_spu" required="" placeholder="Branch Work Base on SPU" value="{{ old('branch_work_base_on_spu') }}" style="width: 100%"></td>
                                </tr>     
                                <tr>
                                    <td>Email <em style="color:red">*</em></td>
                                    <td><input type="email"  class="form-control" name="email" required="" placeholder="Email" value="{{ old('email') }}" style="width: 100%"></td>
                                </tr>       
                                <tr>
