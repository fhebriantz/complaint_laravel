    ...
    <div class="panel box-shadow-none content-header">
        <div class="panel-body">
            <div class="col-md-12">
                ...
                <p class="animated fadeInDown">CMS <span class="fa-angle-right fa"></span> Department <span class="fa-angle-right fa"></span> Create</p>
            </div>
        </div>
    </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="responsive-table">
                        ...
                        @endif
                    	<form method="POST" action="{{url('/department/create')}}">
						{{ csrf_field() }}
	                        <table class="table">  
                                ...
                                <tr>
                                    ...
                                    <td><input type="text"  class="form-control" name="department_name" required="" placeholder="Department Name" value="{{ old('department_name') }}" style="width: 100%"></td>
                                </tr>   
                                <tr>
                                    <td>Department Description <em style="color:red">*</em></td>
                                    <td><textarea class="form-control" name="department_desc" required="" placeholder="Description" style="width: 100%">{{ old('department_desc') }}</textarea></td>
                                </tr> 
                                <tr>
                                    <td>Email</td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="email" class="form-control" name="head_of_department" placeholder="Email Head Of Department" value="{{ old('head_of_department') }}" style="width: 100%"></td>
                                </tr>  
                                <tr>
                                    <td>Manager</td>
